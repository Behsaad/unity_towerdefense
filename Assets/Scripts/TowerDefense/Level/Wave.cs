...
namespace TowerDefense.Level
{
	...
	public class Wave : TimedBehaviour
	{
		...
		protected virtual void SpawnAgent(AgentConfiguration agentConfig, Node node)
		{
            ...
            agentInstance.navMeshNavMeshAgent.speed = 10/randomInt;
            agentInstance.transform.localScale = new Vector3(randomInt * 0.3f, randomInt * 0.3f, randomInt * 0.3f);

            int health = randomInt * 5;
            agentInstance.configuration.maxHealth = health;
            agentInstance.configuration.startingHealth = health;
